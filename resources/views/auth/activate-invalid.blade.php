...
<head>
    ...
    <title>Link Tidak Valid - e-Rapor</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-red-950/30 to-slate-900 flex items-center justify-center p-4">

    <div class="fixed inset-0 overflow-hidden pointer-events-none">
        <div class="absolute -top-40 -right-40 w-96 h-96 bg-red-500/10 rounded-full blur-3xl"></div>
        <div class="absolute -bottom-40 -left-40 w-96 h-96 bg-red-800/10 rounded-full blur-3xl"></div>
    </div>
@extends('layouts.app')

@section('title', 'Tautan Tidak Valid - e-Rapor')
...
<div class="min-h-screen bg-[#F4F6F9] flex flex-col relative font-sans selection:bg-[#003399]/25 selection:text-[#003399]">
    ...
    <div class="relative bg-[#003399] pt-10 pb-20 overflow-hidden z-0">
        ...
        <div class="px-6 relative z-20 mt-8 max-w-md mx-auto">
            ...
            <h2 class="text-3xl font-black text-white tracking-tight leading-none mb-2 uppercase">
                Tautan <br>
                <span class="text-[#FFB800]">Tidak Valid</span>
            </h2>
            <p class="text-[11px] text-white/70 max-w-[280px] font-normal leading-relaxed">
                Sistem mendeteksi adanya ketidaksesuaian, kerusakan, atau kedaluwarsa pada token verifikasi keamanan Anda.
            </p>
        </div>
    ...
    <div class="flex-1 px-6 pt-6 w-full max-w-md mx-auto relative z-10 pb-28 lg:pb-12">
        ...
        <div class="bg-white border border-slate-200 rounded-2xl p-6 mb-6 text-center shadow-sm select-none">
            <div class="w-16 h-16 rounded-2xl bg-red-50 text-red-600 border border-red-100 flex items-center justify-center mx-auto mb-4 shadow-sm animate-pulse">
                <i class="fa-solid fa-link-slash text-2xl"></i>
            </div>

            <h3 class="text-slate-900 text-xs font-black uppercase tracking-wider mb-2">Akses Aktivasi Ditolak</h3>
            <p class="text-slate-600 text-xs font-medium leading-relaxed">
                Tautan aktivasi akun yang Anda gunakan tidak dapat diproses. Kondisi ini umumnya terjadi jika token telah melewati batas kedaluwarsa masa berlaku (**24 jam**) atau tautan sudah pernah digunakan sebelumnya untuk inisialisasi kata sandi.
            </p>
            ...
            <div class="mt-5 bg-slate-50 border border-slate-200 rounded-xl p-3.5 flex items-start gap-3 text-left">
                ...
                <div class="min-w-0 flex-1">
                    <h4 class="text-[10px] font-black text-slate-700 uppercase tracking-wide mb-0.5">Solusi Penyelesaian</h4>
                    <p class="text-slate-500 text-[11px] font-semibold leading-normal">
                        Silakan hubungi pihak Administrator/Tim Kurikulum SMK TI Airlangga untuk meregenerasi token baru dan mengirimkan ulang tautan aktivasi resmi ke alamat email Anda.
                    </p>
                </div>
            </div>
        </div>
...
@endsection
    <div class="w-full max-w-md relative z-10 text-center">
        ...
        <div class="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-red-500/10 border border-red-500/20 mb-6">
            <i class="fa-solid fa-link-slash text-red-400 text-3xl"></i>
        </div>

        <h1 class="text-white font-black text-2xl mb-3">Link Tidak Valid</h1>
        <p class="text-slate-400 text-sm leading-relaxed mb-8">
            Link aktivasi yang Anda gunakan tidak valid atau sudah pernah dipakai sebelumnya.
            Silakan hubungi administrator sekolah untuk mendapatkan link aktivasi baru.
        </p>

        <a href="{{ route('login') }}"
           class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white/5 border border-white/10 text-white text-sm font-bold hover:bg-white/10 transition-all">
