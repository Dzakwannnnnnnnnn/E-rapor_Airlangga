...
@section('title', 'Konfirmasi Kata Sandi - e-Rapor')
...
<div class="min-h-screen bg-[#F4F6F9] flex flex-col relative font-sans selection:bg-[#003399]/25 selection:text-[#003399]">
    ...
    <div class="relative bg-[#003399] pt-10 pb-20 overflow-hidden z-0">
        ...
        <a href="{{ url()->previous() }}" class="absolute top-4 left-6 w-10 h-10 flex items-center justify-center bg-white/10 hover:bg-white/20 border border-white/20 rounded-full text-white shadow-[0_4px_12px_rgba(0,0,0,0.1)] z-20 transition-all backdrop-blur-md">
        ...
        <div class="px-6 relative z-20 mt-8 max-w-md mx-auto">
            ...
            <h2 class="text-3xl font-black text-white tracking-tight leading-none mb-2 uppercase">
                Keamanan <br>
                <span class="text-[#FFB800]">Konfirmasi</span>
            </h2>
            <p class="text-[11px] text-white/70 max-w-[280px] font-normal leading-relaxed">
                Ini adalah area aman aplikasi. Silakan konfirmasi kata sandi Anda terlebih dahulu sebelum melanjutkan tindakan.
            </p>
        </div>
    ...
    <div class="flex-1 px-6 pt-8 w-full max-w-md mx-auto relative z-10 pb-28 lg:pb-12">
        ...
        <form method="POST" action="{{ route('password.confirm') }}" id="confirmPasswordForm" class="flex flex-col">
            @csrf

            <div class="mb-6 relative group">
                <label for="password" class="text-[10px] font-black text-slate-500 uppercase tracking-widest mb-1.5 block ml-1">Kata Sandi Anda</label>
                <div class="relative">
                    <span class="absolute bottom-4 left-4 text-slate-400 group-focus-within:text-[#003399] transition-colors z-10">
                        <i class="fa-solid fa-lock text-sm"></i>
                    </span>
                    <input id="password" type="password" name="password" required autocomplete="current-password" autofocus placeholder="••••••••" maxlength="16"
            ...
            <button type="submit" class="hidden lg:flex w-full bg-[#003399] hover:bg-[#002266] text-white font-black text-xs uppercase tracking-widest py-4 rounded-xl transition-all shadow-lg shadow-[#003399]/20 items-center justify-center gap-2 border-b-2 border-slate-900/20">
                <i class="fa-solid fa-shield-halved text-[#FFB800]"></i>
                Konfirmasi Sandi
            </button>
        </form>
    </div>
    ...
    <div class="lg:hidden fixed bottom-0 left-0 w-full bg-white border-t border-slate-200 p-4 pb-6 shadow-[0_-10px_20px_-10px_rgba(0,0,0,0.05)] z-50">
        <div class="max-w-md mx-auto">
            <button type="submit" form="confirmPasswordForm" class="w-full bg-[#003399] hover:bg-[#002266] text-white font-black text-xs uppercase tracking-widest py-4 rounded-xl transition-all shadow-lg shadow-[#003399]/20 flex items-center justify-center gap-2 border-b-2 border-slate-900/20">
                <i class="fa-solid fa-shield-halved text-[#FFB800]"></i>
                Konfirmasi Sandi
            </button>
        </div>
