...
@section('title', 'Tambah Wali Murid Baru - e-Rapor')
    ...
    <div class="bg-primary text-white pt-10 pb-20 px-6 md:px-8 relative overflow-hidden select-none">
        ...
        <div class="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10">
            ...
            <div class="flex-1 text-center md:text-left min-w-0 mt-1">
                ...
                <h3 class="font-extrabold text-xl md:text-3xl leading-tight uppercase truncate tracking-wide">Tambah Wali Murid</h3>
                ...
                <div class="mt-3 flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-1.5 text-xs md:text-sm text-white/85 font-medium">
                    <div class="flex items-center gap-2">
                        ...
                        <span>Panel Manajemen Pengguna</span>
                    </div>
                    <div class="flex items-center gap-2">
...
<div class="max-w-4xl mx-auto mt-6 space-y-6">
    ...
    <form method="POST" action="{{ route('admin.parents.store') }}" class="space-y-6 px-4 sm:px-0">
        @csrf

        <div class="space-y-3">
            <h4 class="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Formulir Registrasi Wali Murid</h4>
        ...
        <div class="bg-blue-50 border-l-4 border-primary text-slate-900 rounded-2xl p-4 shadow-sm flex items-center gap-4 select-none">
            ...
            <div class="flex-1">
                ...
                <p class="text-xs text-slate-600 mt-0.5 leading-normal">Setelah data disimpan, sistem akan <span class="font-bold text-slate-800">otomatis mengirim email aktivasi</span> ke alamat yang dimasukkan. Wali murid cukup klik link di email untuk membuat kata sandi mereka sendiri.</p>
            </div>
        </div>
