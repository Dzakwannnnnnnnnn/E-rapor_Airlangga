...
@section('title', 'Edit Guru - ' . $user->name . ' - e-Rapor')
    ...
    <div class="bg-primary text-white pt-10 pb-20 px-6 md:px-8 relative overflow-hidden select-none">
        ...
        <div class="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-6 relative z-10">
            ...
            <div class="flex-1 text-center md:text-left min-w-0 mt-1">
                ...
                <h3 class="font-extrabold text-xl md:text-3xl leading-tight uppercase truncate tracking-wide">Edit Data Pendidik</h3>
...
<div class="max-w-4xl mx-auto mt-6 space-y-6">
    ...
    <form id="edit-teacher-form" method="POST" action="{{ route('admin.teachers.update', $user->id) }}" class="space-y-6 px-4 sm:px-0">
        @csrf
        @method('PUT')

        <div class="space-y-3">
            <h4 class="text-xs font-black text-slate-400 uppercase tracking-widest pl-1">Perbarui Informasi Pendidik</h4>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="nip" id="nip" value="{{ old('nip', $user->teacher->nip ?? '') }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <select name="gender" id="gender" required
                                ...
                                <option value="L" {{ old('gender', $user->teacher->gender ?? '') == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="P" {{ old('gender', $user->teacher->gender ?? '') == 'P' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="telp" id="telp" value="{{ old('telp', $user->teacher->telp ?? '') }}" required
